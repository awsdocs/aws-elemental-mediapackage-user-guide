...
| Added Amazon CloudWatch Events information\. | Added [[ERROR] BAD/MISSING LINK TEXT](monitoring-cloudwatch-events.md) section about the CloudWatch Events that AWS Elemental MediaPackage supports\. | February 14, 2018 | 
