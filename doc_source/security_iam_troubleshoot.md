# Troubleshooting MediaPackage identity and access<a name="security_iam_troubleshoot"></a>
...
## I'm not authorized to perform an action in MediaPackage<a name="security_iam_troubleshoot-no-permissions"></a>
