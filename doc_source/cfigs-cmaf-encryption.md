...
1. For **System IDs**, enter unique identifiers for your streaming protocol and DRM system\. Provide up to two system IDs\. If you provide more than one system ID, enter one per line and choose **Add**\. If you do not know your IDs, ask your DRM solution provider\.