...
**Important**  
Multiple periods are required if you use MediaTailor for personalized ad insertion in DASH content\. For more information about this service, see the [MediaTailor User Guide](https://docs.aws.amazon.com/mediatailor/latest/ug/)\.