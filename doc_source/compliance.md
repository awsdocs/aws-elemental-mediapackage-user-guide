...
You can download third\-party audit reports using AWS Artifact\. For more information, see [Downloading Reports in AWS Artifact](https://https://docs.aws.amazon.com/artifact/latest/ug/downloading-documents.html)\. 
