...
| [MediaPackage now supports SPEKE v2](using-encryption.md) | Added information about SPEKE v2\. | September 7, 2021 | 
| [New guidance for integrating with SPEKE v2](encryption-choosing-speke-version.md) | MediaPackage now supports SPEKE v2\. | September 6, 2021 | 
...
| [Updated cost allocation tagging content\.](tagging.md) | Clarified that cost allocation tagging is currently only available for \. | May 27, 2021 | 
| [MediaPackage now supports DASH endpoints for live\-to\-VOD](ltov-reqmts.md) | Added DASH endpoint requirements for live\-to\-VOD\. | May 14, 2021 | 
